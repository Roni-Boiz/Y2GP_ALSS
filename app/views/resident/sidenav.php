...
<body>
    <div id="myheader">
        <div class="header">
            ...
            <div class="head">
                <ul>
                    <li class="dropdown"><a href="#"><img src="../../uploads/profile/resident/<?php echo $_SESSION["profilePic"] ?>" onerror="this.onerror=null; this.src='../../public/img/blank-profile.png'"></a>
                        <ul>
